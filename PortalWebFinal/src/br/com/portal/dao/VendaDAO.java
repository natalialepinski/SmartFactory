...
public class VendaDAO {
	...
	public void adiciona(Venda venda) throws SQLException {
		...
		String sql = "INSERT INTO T_SYS_VENDA"
				+ "(cd_venda, cd_cliente, dt_emissao, vl_total, st_venda)"
				+ "values (seq_cd_venda.nextval, ?, ?, ?, ?)";
	...
	public ArrayList<Venda> getLista() throws SQLException{
		...
		try {
			...
			PreparedStatement statement = this.connection.prepareStatement("SELECT * FROM T_SYS_VENDA");
