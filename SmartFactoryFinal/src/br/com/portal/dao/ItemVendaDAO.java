...
public class ItemVendaDAO {
	...
	public void adiciona(ItemVenda itemVenda, int codigo) throws SQLException {

		Connection conn = null;

		String sql = "INSERT INTO T_SYS_VENDA_PRODUTO" + "(cd_venda_produto, qt_produto, cd_produto, vl_total, cd_venda)" + "values (seq_cd_item_venda.nextval, ?, ?, ?, ?)";
